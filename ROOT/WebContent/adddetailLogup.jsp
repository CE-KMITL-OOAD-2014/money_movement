  ...
  <body class="bd-bg">
    ...
    <div class="row container-div">
		<div class="col-md-6 col-md-offset-3 bg-aside">
			...
			<form role="form" action="register" method="post" class="float-con">
				...
				<div class="col-md-12 form-group">
					...
					<input type="text" class="form-control" name="province"  id="Province" placeholder="Province at your live">
				</div>
				<!--<div class="form-group">
